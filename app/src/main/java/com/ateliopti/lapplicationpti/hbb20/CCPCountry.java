...
public class CCPCountry implements Comparable<CCPCountry> {
    ...
    static com.ateliopti.lapplicationpti.hbb20.CountryCodePicker.Language getLoadedLibraryMasterListLanguage() {
        return loadedLibraryMasterListLanguage;
    }

    static void setLoadedLibraryMasterListLanguage(com.ateliopti.lapplicationpti.hbb20.CountryCodePicker.Language loadedLibraryMasterListLanguage) {
     ...
     */
    static void loadDataFromXML(Context context, com.ateliopti.lapplicationpti.hbb20.CountryCodePicker.Language language) {
        ...
        if (countries.size() == 0) {
            loadedLibraryMasterListLanguage = com.ateliopti.lapplicationpti.hbb20.CountryCodePicker.Language.ENGLISH;
    ...
    static CCPCountry getCountryForNumber(Context context, CountryCodePicker.Language language, List<CCPCountry> preferredCountries, String fullNumber) {
        ...
        if (fullNumber.length() != 0) {
            ...
            for (int i = firstDigit; i <= fullNumber.length(); i++) {
                ...
                com.ateliopti.lapplicationpti.hbb20.CCPCountryGroup countryGroup = null;
                try {
                    countryGroup = com.ateliopti.lapplicationpti.hbb20.CCPCountryGroup.getCountryGroupForPhoneCode(Integer.parseInt(code));
