...
public class CountryCodePicker extends RelativeLayout {
    ...
    private com.ateliopti.lapplicationpti.hbb20.CCPTalkBackTextProvider talkBackTextProvider = new com.ateliopti.lapplicationpti.hbb20.InternalTalkBackTextProvider();
    ...
    com.hbb20.InternationalPhoneTextWatcher formattingTextWatcher;
    ...
    private com.ateliopti.lapplicationpti.hbb20.CCPCountryGroup currentCountryGroup;
    ...
    private void updateFormattingTextWatcher() {
        if (editText_registeredCarrierNumber != null && selectedCCPCountry != null) {
            ...
            if (numberAutoFormattingEnabled) {
                formattingTextWatcher = new com.hbb20.InternationalPhoneTextWatcher(context, getSelectedCountryNameCode(), getSelectedCountryCodeAsInt(), internationalFormattingOnly);
