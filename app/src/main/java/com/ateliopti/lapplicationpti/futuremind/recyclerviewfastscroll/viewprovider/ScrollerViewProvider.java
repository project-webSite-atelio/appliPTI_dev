...
public abstract class ScrollerViewProvider {
    ...
    private com.futuremind.recyclerviewfastscroll.viewprovider.ViewBehavior handleBehavior;
    private com.futuremind.recyclerviewfastscroll.viewprovider.ViewBehavior bubbleBehavior;
    ...
    @Nullable
    protected abstract com.futuremind.recyclerviewfastscroll.viewprovider.ViewBehavior provideHandleBehavior();

    @Nullable
    protected abstract com.futuremind.recyclerviewfastscroll.viewprovider.ViewBehavior provideBubbleBehavior();

    protected com.futuremind.recyclerviewfastscroll.viewprovider.ViewBehavior getHandleBehavior(){
        if(handleBehavior==null) handleBehavior = provideHandleBehavior();
        return handleBehavior;
    }

    protected com.futuremind.recyclerviewfastscroll.viewprovider.ViewBehavior getBubbleBehavior(){
