package com.ateliopti.lapplicationpti.futuremind.recyclerviewfastscroll;
...
import com.ateliopti.lapplicationpti.futuremind.recyclerviewfastscroll.viewprovider.ScrollerViewProvider;
import com.ateliopti.lapplicationpti.futuremind.recyclerviewfastscroll.viewprovider.DefaultScrollerViewProvider;
import com.ateliopti.lapplicationpti.futuremind.recyclerviewfastscroll.viewprovider.ScrollerViewProvider;
...
public class FastScroller extends LinearLayout {
    ...
    private final com.ateliopti.lapplicationpti.futuremind.recyclerviewfastscroll.RecyclerViewScrollListener scrollListener = new com.ateliopti.lapplicationpti.futuremind.recyclerviewfastscroll.RecyclerViewScrollListener(this);
    ...
    private com.futuremind.recyclerviewfastscroll.SectionTitleProvider titleProvider;
    ...
    public void setRecyclerView(RecyclerView recyclerView) {
        ...
        if (recyclerView.getAdapter() instanceof com.futuremind.recyclerviewfastscroll.SectionTitleProvider)
            titleProvider = (com.futuremind.recyclerviewfastscroll.SectionTitleProvider) recyclerView.getAdapter();
     ...
     * @param listener
     */
    public void addScrollerListener(com.ateliopti.lapplicationpti.futuremind.recyclerviewfastscroll.RecyclerViewScrollListener.ScrollerListener listener) {
    ...
    private void setBackgroundTint(View view, int color) {
        ...
        com.futuremind.recyclerviewfastscroll.Utils.setBackground(view, background);
    }
    ...
    private float getRelativeTouchPosition(MotionEvent event) {
        if (isVertical()) {
            float yInParent = event.getRawY() - com.futuremind.recyclerviewfastscroll.Utils.getViewRawY(handle);
            return yInParent / (getHeight() - handle.getHeight());
        } else {
            float xInParent = event.getRawX() - com.futuremind.recyclerviewfastscroll.Utils.getViewRawX(handle);
    ...
    private void setRecyclerViewPosition(float relativePos) {
        ...
        int targetPos = (int) com.futuremind.recyclerviewfastscroll.Utils.getValueInRange(0, itemCount - 1, (int) (relativePos * (float) itemCount));
    ...
    void setScrollerPosition(float relativePos) {
        if (isVertical()) {
            bubble.setY(com.futuremind.recyclerviewfastscroll.Utils.getValueInRange(
                    0,
                    getHeight() - bubble.getHeight(),
                    relativePos * (getHeight() - handle.getHeight()) + bubbleOffset)
            );
            handle.setY(com.futuremind.recyclerviewfastscroll.Utils.getValueInRange(
                    0,
                    getHeight() - handle.getHeight(),
                    relativePos * (getHeight() - handle.getHeight()))
            );
        } else {
            bubble.setX(com.futuremind.recyclerviewfastscroll.Utils.getValueInRange(
                    0,
                    getWidth() - bubble.getWidth(),
                    relativePos * (getWidth() - handle.getWidth()) + bubbleOffset)
            );
            handle.setX(com.futuremind.recyclerviewfastscroll.Utils.getValueInRange(
                    0,
