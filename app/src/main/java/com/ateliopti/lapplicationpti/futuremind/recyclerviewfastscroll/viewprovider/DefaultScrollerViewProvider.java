...
public class DefaultScrollerViewProvider extends ScrollerViewProvider {
    ...
    @Override
    protected com.futuremind.recyclerviewfastscroll.viewprovider.ViewBehavior provideHandleBehavior() {
        return null;
    }

    @Override
    protected com.futuremind.recyclerviewfastscroll.viewprovider.ViewBehavior provideBubbleBehavior() {
        return new com.ateliopti.lapplicationpti.futuremind.recyclerviewfastscroll.viewprovider.DefaultBubbleBehavior(new VisibilityAnimationManager.Builder(bubble).withPivotX(1f).withPivotY(1f).build());
    }
